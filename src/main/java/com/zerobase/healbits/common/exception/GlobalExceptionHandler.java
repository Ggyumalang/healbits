...
import static com.zerobase.healbits.common.type.ErrorCode.BAD_CREDENTIALS;
import static com.zerobase.healbits.common.type.ErrorCode.FAILED_CONVERT_VALUE_OF_TYPE;
import static com.zerobase.healbits.common.type.ErrorCode.HTTP_MESSAGE_NOT_READABLE;
import static com.zerobase.healbits.common.type.ErrorCode.INTERNAL_SERVER_ERROR;

import com.zerobase.healbits.common.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleValidationExceptions(
        MethodArgumentTypeMismatchException me) {
        return ResponseEntity.badRequest().body(ErrorResponse.builder()
